...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8473775530:AAEEq3Cy8ayBcVupnkE6gL_BHtDJanPysq4")

CREDIT = os.environ.get("CREDIT", "〱ＵＧ▕")
# MongoDB Configuration
DATABASE_NAME = os.environ.get("DATABASE_NAME", "Cluster0")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://sumittheking03:sumittheking03@cluster0.80y9glg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
MONGO_URL = DATABASE_URL  # For auth system

# Owner and Admin Configuration
OWNER_ID = int(os.environ.get("OWNER_ID", "6050965589"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "6050965589").split()]  # Default to owner ID
